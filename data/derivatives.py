import random
from sympy import symbols, diff, Function, exp, sin, cos
import json

# Create a list to store the functions and their derivatives
functions = []
...
for i in range(10000):
    ...
    # Add the function and its derivative to the list
    functions.append((expr, derivative))

# Export the functions and their derivatives to a JSON file
data = []
for func, derivative in functions:
    prompt = "f(x) = {}, f'(x) = ".format(func)
    completion = "{}".format(derivative)
